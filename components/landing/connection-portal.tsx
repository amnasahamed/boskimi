          ...
          {isSubmitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <label htmlFor={`${idPrefix}-name`} className="block text-sm text-muted-foreground mb-2">Your Name</label>
                  <input
                    id={`${idPrefix}-name`}
                    type="text"
                    required
                ...
                <div>
                  <label htmlFor={`${idPrefix}-email`} className="block text-sm text-muted-foreground mb-2">Email</label>
                  <input
                    id={`${idPrefix}-email`}
                    type="email"
                    required
              ...
              <div>
                <label htmlFor={`${idPrefix}-company`} className="block text-sm text-muted-foreground mb-2">Company (optional)</label>
                <input
                  id={`${idPrefix}-company`}
                  type="text"
              ...
              <div>
                <label htmlFor={`${idPrefix}-message`} className="block text-sm text-muted-foreground mb-2">
