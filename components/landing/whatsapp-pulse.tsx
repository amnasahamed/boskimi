              ...
              <div className="relative bg-card border-2 border-border rounded-[2.5rem] p-2 shadow-2xl">
                ...
                <div className="bg-background rounded-[2rem] overflow-hidden">
                  ...
                  <div className="flex items-center gap-2 px-3 py-3 border-t border-border/50 bg-card/30">
                    <button aria-label="Add attachment" className="w-8 h-8 rounded-full flex items-center justify-center text-muted-foreground hover:text-foreground transition-colors">
                    ...
                    <button aria-label="Send message" className="w-9 h-9 rounded-full bg-primary flex items-center justify-center shadow-lg hover:scale-105 transition-transform">
