...
const inputSources = [
  { icon: Mail, label: "Emails", color: "#FF4B1F" },
  { icon: Database, label: "Database", color: "#FFD700" },
          ...
          >
            <defs>
              ...
              <linearGradient id="grad-blue" x1="0%" y1="0%" x2="100%" y2="0%">
                ...
                <stop offset="100%" stopColor="#FF4B1F" stopOpacity="0.1" />
              </linearGradient>
            ...
            <g strokeWidth="2.5" fill="none" filter="url(#line-glow)">
              {/* Blue - Emails */}
              <path stroke="#FF4B1F" strokeDasharray="30 150" opacity="0.9">
              ...
              {/* Purple - Database */}
              <path stroke="#FFD700" strokeDasharray="30 150" opacity="0.9">
